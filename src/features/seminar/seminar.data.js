 ...
 *
 * `SEMINARS` mirrors the original mock schedule shape; the page now fetches
 * it from the backend via seminar.api.js, so it's currently unused. Keep
 * only the static copy (badge maps, attend labels, messages, empty/toast
 * strings) here.
 *

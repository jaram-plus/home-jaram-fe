...
export const SCHEMAS = {
  ...
  exec: {
    ...
    cols: [
      ...
      { key: 'cohort', label: '기수', type: 'text', width: '0.5fr', align: 'center' },
  ...
  graduate: {
    ...
    filters: [{ key: 'cohort', label: '기수', options: ['전체', '36기', '35기', '34기', '33기', '32기', '31기'] }],
    cols: [
...
export const SEED = {
  member: [
    { id: 'm1', name: '김서준', studentId: '2024093117', cohort: '41기', grade: '수습회원', status: '활동', phone: '010-2841-5573' },
    { id: 'm2', name: '이하은', studentId: '2024093208', cohort: '41기', grade: '수습회원', status: '활동', phone: '010-7712-0094' },
    { id: 'm3', name: '박도윤', studentId: '2023091144', cohort: '40기', grade: '준회원', status: '활동', phone: '010-3390-8821' },
    { id: 'm4', name: '정시우', studentId: '2023090021', cohort: '40기', grade: '준회원', status: '휴학', phone: '010-5560-1187' },
    { id: 'm5', name: '최유나', studentId: '2022089910', cohort: '39기', grade: '정회원', status: '활동', phone: '010-2201-7746' },
    { id: 'm6', name: '강준혁', studentId: '2022088804', cohort: '39기', grade: '정회원', status: '활동', phone: '010-9983-2210' },
    { id: 'm7', name: '윤서아', studentId: '2021087700', cohort: '38기', grade: '정회원', status: '활동', phone: '010-4417-6650' },
  ],
  exec: [
    { id: 'e1', name: '강준혁', studentId: '2022088804', cohort: '39기', department: '회장단', position: '회장', term: '2026' },
    { id: 'e2', name: '윤서아', studentId: '2021087700', cohort: '38기', department: '회장단', position: '부회장', term: '2026' },
    { id: 'e3', name: '최유나', studentId: '2022089910', cohort: '39기', department: '학술부', position: '부장', term: '2026' },
    { id: 'e4', name: '박도윤', studentId: '2023091144', cohort: '40기', department: '홍보부', position: '부장', term: '2026' },
    { id: 'e5', name: '정시우', studentId: '2023090021', cohort: '40기', department: '회계부', position: '부장', term: '2026' },
    { id: 'e6', name: '이하은', studentId: '2024093208', cohort: '41기', department: '인프라', position: '부원', term: '2026' },
  ],
  contrib: [
    { id: 'c1', name: '박나눔', cohort: '38기', type: '전 임원', contribution: '전 회장 · 재학생 대상 백엔드·인프라 정기 멘토링', link: 'github.com/parknanum' },
    { id: 'c2', name: '김선배', cohort: '37기', type: '전 임원', contribution: '전 학술부장 · 세미나 운영 노하우 문서화 및 인수인계', link: 'blog.jaram.dev/kim' },
    { id: 'c3', name: '이멘토', cohort: '외부', type: '외부 자문', contribution: '실무 코드 리뷰·커리어 상담 (현 카카오 시니어 개발자)', link: 'github.com/leementor' },
    { id: 'c4', name: '정오픈', cohort: '39기', type: '전 임원', contribution: '전 인프라 담당 · 자람 홈페이지 오픈소스 유지보수 기여', link: 'github.com/jeongopen' },
    { id: 'c5', name: '유강연', cohort: '외부', type: '멘토', contribution: '외부 연사 · AI 트렌드 특별 세미나 2회 진행', link: 'blog.yukang.io' },
    { id: 'c6', name: '한동문', cohort: '32기', type: '후원자', contribution: '동문 · 학회 서버 비용 및 정기 세미나 다과 후원', link: '—' },
  ],
  graduate: [
    { id: 'g1', name: '한지호', cohort: '35기', gradYear: '2021', org: '네이버', job: '백엔드 엔지니어' },
    { id: 'g2', name: '오세훈', cohort: '34기', gradYear: '2020', org: '카카오', job: '안드로이드 개발자' },
    { id: 'g3', name: '임채원', cohort: '33기', gradYear: '2019', org: '라인', job: '프론트엔드 개발자' },
    { id: 'g4', name: '서동건', cohort: '32기', gradYear: '2018', org: '쿠팡', job: '데이터 엔지니어' },
    { id: 'g5', name: '백지안', cohort: '36기', gradYear: '2022', org: '토스', job: 'iOS 개발자' },
    { id: 'g6', name: '남기훈', cohort: '31기', gradYear: '2017', org: '삼성전자', job: 'SW 엔지니어' },
  ],
  seminars: [
